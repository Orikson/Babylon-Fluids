...
export function setup() {
    ...
    BABYLON.Effect.IncludesShadersStore["stam3D_300es_header"] = `
    precision highp float;
    ...
    in vec3 bbPosition;
    in vec3 bbWorldSize;
    in vec4 bbQuaternion;
    in vec3 bbResolution;
    ...
    vec4 texture3D_CTB(sampler2D x, vec3 uv3d, vec3 res) {
        ...
        return texture(x, getCoords(uv3d, res));
    }
